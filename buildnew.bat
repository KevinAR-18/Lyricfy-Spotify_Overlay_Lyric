...
echo ========================================
echo Building Lyricfy %VERSION% onedir...
echo ========================================
echo.
...
echo Building executable folder...
echo.
...
echo Copying icon.ico to app folder...
copy /y icon.ico dist\Lyricfy\icon.ico >nul
...
echo Output: dist\Lyricfy\Lyricfy.exe
echo Icon: dist\Lyricfy\icon.ico
echo ========================================
echo.
